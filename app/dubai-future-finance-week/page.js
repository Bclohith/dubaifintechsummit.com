      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.logoWrapper}>
            <img 
              src="/dubaifintechsummit.com/dubai-future-fintech-week-logo.svg" 
          ...
          <div className={styles.featuresGrid}>
            ...
            <div className={styles.featureCard}>
              ...
              <div className={styles.cardImageWrapper}>
                <img src="/dubaifintechsummit.com/connected-world.webp" alt="Global Ecosystem" className={styles.cardImage} />
            ...
            <div className={styles.featureCard}>
              <div className={styles.cardGlow} />
              <div className={styles.cardImageWrapper}>
                <img src="/dubaifintechsummit.com/fintechs.webp" alt="Innovation Labs" className={styles.cardImage} />
                <div className={styles.imageOverlay} />
              </div>
              <div className={styles.cardContent}>
            ...
            <div className={styles.featureCard}>
              <div className={styles.cardGlow} />
              <div className={styles.cardImageWrapper}>
                <img src="/dubaifintechsummit.com/bank-executives.webp" alt="Executive Networking" className={styles.cardImage} />
                <div className={styles.imageOverlay} />
              </div>
              <div className={styles.cardContent}>
