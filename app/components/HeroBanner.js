      ...
      <div className={`${styles.contentLayer} ${loaded ? styles.visible : ''}`}>
        ...
        <div className={styles.centerContent}>
          ...
          <div className={styles.secondaryLogosContainer}>
            <img src="/dubaifintechsummit.com/" alt="Part of Dubai Future Finance Week" className={styles.secondaryLogo} />
            <div className={styles.logoDivider}></div>
            <img src="/dubaifintechsummit.com/" alt="Organised by DIFC" className={styles.secondaryLogo} />
          </div>
        </div>
