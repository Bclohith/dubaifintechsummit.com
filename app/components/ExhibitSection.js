      ...
      <div className={styles.container}>
        ...
        <div className={styles.scatterGrid}>
          ...
          <div className={`${styles.scatterItem} ${styles.scatterPos1}`}>
            <img src="/dubaifintechsummit.com/" alt="FinTech Exhibit" className={styles.scatterImage} />
            <div className={styles.imageGlow}></div>
          </div>
          
          <div className={`${styles.scatterItem} ${styles.scatterPos2}`}>
            <img src="/dubaifintechsummit.com/" alt="Data Streams" className={styles.scatterImage} />
            <div className={styles.imageGlow}></div>
          </div>
          
          <div className={`${styles.scatterItem} ${styles.scatterPos3}`}>
            <img src="/dubaifintechsummit.com/" alt="Live Demos" className={styles.scatterImage} />
            <div className={styles.imageGlow}></div>
          </div>
          
          <div className={`${styles.scatterItem} ${styles.scatterPos4}`}>
            <img src="/dubaifintechsummit.com/" alt="Networking" className={styles.scatterImage} />
            <div className={styles.imageGlow}></div>
          </div>
